...
export default function EventDetailPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 bg-gray-50 min-h-screen">
      ...
      {loading ? (
        <div className="text-gray-600 text-center py-12">Loading event details...</div>
      ) : !evt ? (
        <div className="text-red-600 text-center py-12 bg-white rounded-lg shadow-sm">
              ...
              <div className="md:col-span-2">
                <div className="flex items-start justify-between">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-blue-600">{evt.price} HBAR</div>
                ...
                <div className="mt-4">
                  ...
                  <div className="text-gray-700 whitespace-pre-wrap">{evt.description}</div>
                </div>
              </div>
            </div>
          </div>
              ...
              {resolvedEventId && evt.hederaTicketTokenId && (
                <div className="mt-4">
                  <a
                    ...
                    className="inline-block px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-lg text-sm"
                  >
                    Check-In
                  </a>
                </div>
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      className="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <button
                  ...
                  onClick={onBuy}
                  disabled={buying}
                  className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
                >

...
export default function CheckInPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 bg-gray-50 min-h-screen text-gray-900">
      {toast && (
        <div
          className={`fixed top-6 right-6 z-50 px-4 py-3 rounded-lg shadow-lg ${toast.type === 'success' ? 'bg-green-600 text-white' : 'bg-red-600 text-white'}`}
        >
          {toast.text}
        </div>
      )}
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        ...
        <button
          ...
          onClick={onSubmit}
          disabled={submitting}
          className="mt-4 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg disabled:opacity-60"
        >
